    ...
    <div class="content0">
        ...
        <div class="center-bottom">
          ...
          <div class="content">
            <div class="chart-wrapper">
              <haoping
                v-if="countMonthlysif"
                :chart-data="countMonthlys"
                width="100%"
                height="100%"
              />
            </div>
      ...
      <div class="right">
        ...
        <div class="content">
          <div class="chart-wrapper">
            <hcdd
              v-if="countAnnuallysif"
              :chart-data="countAnnuallys"
              width="100%"
              height="100%"
            />
          </div>
    ...
    <div class="content1">
      ...
      <div class="rightZ">
        ...
        <div class="content">
          <div class="chart-wrapper">
            <meigui
              v-if="getAreaDimensionsif"
              :chart-data="getAreaDimensions"
              height="100%"
              width="100%"
            />
          </div>
      ...
      tourController({ category: this.category })
        .then(res => {
          ...
          if (res.status === 200) {
            ...
            console.log(this.tourControllers, "新坐标");
            // this.markers[0].position = this.tourControllers
          }
        })
        .catch(err => {
          console.log(err);
